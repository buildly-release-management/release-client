...
"xstate.init": { type: "xstate.init" };
        ...
        eventsCausingActions: {
          "addErrorToCxt": "error.platform.releases.Deleting:invocation[0]" | "error.platform.releases.Entry.Loading:invocation[0]" | "error.platform.releases.Submitting.Updating:invocation[0]";
